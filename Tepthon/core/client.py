                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @SSSTF\
                                  \n\n--------بـدء تتبـع سجـل الزعيم alzaeim--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع الزعيم alzaeim--------"
                        ...
                        link = "[ᯓ𓆩𖡡𓏺.𝑨𝑳𝒁𝑨𝑰𝑴.𓏺𖡡𓆪](https://t.me/SSSTF)"
                        text = (
                            "**✘ تقـريـر إشعـار الزعيم alzaeim ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار الزعيم alzaeim ✘**\n\n "
                        link = "[ᯓ𓆩𖡡𓏺.𝑨𝑳𝒁𝑨𝑰𝑴.𓏺𖡡𓆪](https://t.me/SSSTF)"
