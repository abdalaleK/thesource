            ...
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ريبثون surs alzaeim--------"
                        ...
                        link = "[𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐩𝐭𝐡𝐨𝐧𝐞](https://t.me/EE77n)"
                        text = (
                            "**✘ تقـريـر إشعـار تيبثـون 𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐩𝐭𝐡𝐨𝐧𝐞  ✘**\n\n"
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  \n\nنسجل فقـط تقريـر الإشعـار وتـاريخـه ،\
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @EE77n\
                                  \n\n--------بـدء تتبـع سجـل ريبثون surs alzaeim--------\
                                  \n- التـاريـخ : {date}\n- ايـدي الكـروب : {str(check.chat_id)}\
                                  \n- ايـدي الشخـص : {str(check.sender_id)}\
                                  \n- رابـط الرسـالـه : {await check.client.get_msg_link(check)}\
                                  \n\n- التقـريـر :\n{str(check.text)}\
                        ...
                        text = "**✘ تقـريـر إشعـار تيبثـون  𝐒𝐨𝐮𝐫𝐜𝐞 𝐑𝐞𝐩𝐭𝐡𝐨𝐧𝐞 ✘**\n\n "
                        link = "[الزعيم](https://t.me/EE77n)"
