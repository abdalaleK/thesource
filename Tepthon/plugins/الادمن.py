...
zel_dev = (6488920279, 6488920279, 6488920279, 6488920279)
...
async def _ban_person(event):
    ...
    if user.id == 6700336976 or user.id == 6488920279 or user.id == 6488920279:
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if event.chat_id == 6700336976 or event.chat_id == 6488920279 or event.chat_id == 6488920279:
