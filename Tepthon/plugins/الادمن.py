...
async def _ban_person(event):
    ...
    if user.id == 1260465030 or user.id == 6723830547 or user.id == 6723830547:
...
async def startmute(event):
    KTM_IMG = gvarstatus("KTM_PIC") or "https://graph.org/file/0223f01a1420743b960da.jpg"
    if event.is_private:
        ...
        if event.chat_id == 925972505 or event.chat_id == 6723830547 or event.chat_id == 6723830547:
...
async def kick(event):
    ...
    if user.id == 925972505 or user.id == 6723830547 or user.id == 6723830547:
