...
ZelzalVP_cmd = (
    ...
    "⪼ `.اضف كليشة الايدي` بالـرد ع الكليشـه مـن القنـاة@SSSTF2kalesh \n\n\n"
    ...
    "⪼ قنـاة كلايـش حمايـة الخـاص @SSSTF2\n\n"
    ...
    "\n𓆩 [ المطور  - قنـاة الفـارات](t.me/SSSTF) 𓆪"
)
...
ZelzalTZ_cmd = (
    ...
    "𓆩 [ 𝗩𝗮𝗿𝘀 - قنـاة الفـارات](t.me/SSSTF) 𓆪"
)
...
async def variable(event):
    ...
    zed = await edit_or_reply(event, "**⎉╎جـاري إعـداد المنطقـة الزمنيـة لـ الزعيم 🌐...**")
    # All Rights Reserved for "Zed-Thon" "زلـزال الهيبـه"
    ...
    if tiba.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            try:
                ...
                await rep.edit("**⎉╎تم تغييـر صـورة {} .. بنجـاح ☑️**\n**⎉╎المتغيـر : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس :@SSSTF2**".format(input_str, vinfo))
