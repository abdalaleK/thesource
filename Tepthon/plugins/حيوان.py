...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 سورس الزعيم 𓆪 </b> - @SSSTF2 "
...
async def who(event):
    ...
    if replied_user.id == 6723830547 or replied_user.id == 1895219306 or replied_user.id == 2095357462:
